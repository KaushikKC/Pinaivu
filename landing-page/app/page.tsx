  ...
  return (
    <div className="relative z-1">
      ...
      <section id="roadmap">
        ...
        <div className="grid grid-cols-4 gap-0 px-(--content-pad) max-w-(--content-max) mx-auto max-[1024px]:grid-cols-2 max-[720px]:grid-cols-1">
          {([
            ...
            { delay: 'reveal-d2', active: false, p: '0', tag: 'Queued', date: 'Phase E · H1 2027', title: 'Multi-Chain Settlement', items: ['Move escrow beyond mainnet','Second settlement adapter live','Multi-chain settlement matrix','TOML-selectable chains'] },
      ...
      <footer className="flex flex-wrap items-center justify-between gap-5 border-t border-line px-(--content-pad) py-12 max-w-(--content-max) mx-auto">
        ...
        <ul className="flex list-none gap-5 flex-wrap">
          <li><a href="https://chat.pinaivu.com/" target="_blank" rel="noopener noreferrer" className="font-mono text-[9px] tracking-[0.22em] uppercase text-fg-3 transition-colors duration-300 hover:text-fg">App</a></li>
